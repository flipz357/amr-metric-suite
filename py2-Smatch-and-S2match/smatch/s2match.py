...
def build_arg_parser():
    ...
    parser.add_argument('-diffsense', required=False, type=float, default=0.5,
                        help='coefficient of similarity when senses differ,'\
                                'e.g. hit-01 vs hit-02 ---> coef*1.0 ;;;;; hit-01 vs jump-0x ---> coef*sim(hit,jump)')
        ...
        for j in range(i+1, len(mapping)):
            ...
            if verbose:
                ...
                if new_match_num != cur_match_num + sw_gain:
                    print >> ERROR_LOG, new_match_num, cur_match_num, sw_gain
...
#            print "Smatch score: %.3f" % best_f_score
    ...
    if verbose:
        ...
        print >> DEBUG_LOG, total_match_num_soft, total_test_num, total_gold_num
        print >> DEBUG_LOG, "---------------------------------------------------------------------------------"
